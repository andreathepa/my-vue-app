...
<template lang="">
    <div>
        <div class="container flex justify-content-between wrap">
            <AppCard v-for="(comic, index) in comics" :key="index" :image="comic.thumb" :title="comic.series" :type="comic.type" :price="comic.price"/>
